...
Current status: scaffolded, with staff login, Super Admin route protection, institution membership enforcement, Authority Grant enforcement, student register ingestion, result batch creation, learner passport access, share-link verification, Ed25519 JOSE/JWS credential signing, and first automated security tests added. PostgreSQL still needs to be started locally before migrations and seed can run.
