...
- Engineer 1 decision: PARTIAL - v5 schema foundation is implemented and migrated. API contracts, endpoints, assigned-scope enforcement, rollover behavior, and Founder Console v5 surfaces remain open.
